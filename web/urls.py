...
urlpatterns = [
    ...
    path("b/<slug:business_slug>/slots/", views.public_booking_slots, name="booking_slots"),
    path("b/<slug:business_slug>/randevu/", views.public_booking_submit, name="booking_submit"),
